            ...
            <div class="card rounded-0 border-0 shadow-sm mb-4">
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control rounded-0" id="description" rows="6" name='description' value='{{$SP->description}}'></textarea>
                </div>
                <div class="row">
                  <div class="col mb-3">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col mb-3">
                    ...
                    <input type="number" class="form-control rounded-0" id="sale_price" name='sale_price'min="0" value='{{$SP->sale_price}}'>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card rounded-0 border-0 shadow-sm">
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <input type="hidden" value='{{$SP->image}}' name='imgdefault'>
